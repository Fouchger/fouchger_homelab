...
# Created: 2026-01-31
# Updated: 2026-01-31
# Description: Command entrypoint (templates).
...
templates_impl() {
  ui_info "Not implemented yet" "templates.sh is a placeholder. See docs/specs for the contract."
  return 0
}

main() {
  command_run "templates" templates_impl "$@"
}
