...
declare -A DLG_DEF_H=(
  ...
  [msgbox]=50 [yesno]=10 [infobox]=6
  [inputbox]=50 [passwordbox]=10
  [form]=50 [mixedform]=20 [passwordform]=20
  [gauge]=8 [mixedgauge]=12 [pause]=8
  [textbox]=50 [tailbox]=20 [tailboxbg]=20 [progressbox]=20 [programbox]=20 [prgbox]=20
